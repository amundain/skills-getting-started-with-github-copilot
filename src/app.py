...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 15,
        "participants": ["laura@mergington.edu", "ethan@mergington.edu"]
    },
    "Swimming Club": {
    ...
    "Art Studio": {
        "description": "Creative art projects using painting, drawing, and sculpture",
    ...
    "Science Club": {
        "description": "Conduct experiments and explore science topics in depth",
